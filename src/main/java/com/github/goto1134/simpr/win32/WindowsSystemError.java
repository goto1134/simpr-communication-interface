...
public enum WindowsSystemError
    ...
    DNS_ERROR_RCODE_NO_ERROR(NO_ERROR.value),
    ...
    DNS_ERROR_RCODE_LAST(DNS_ERROR_RCODE_BADTIME.value),
    ...
    DNS_STATUS_PACKET_UNSECURE(DNS_ERROR_UNSECURE_PACKET.value),
    DNS_ERROR_NO_MEMORY(ERROR_OUTOFMEMORY.value),
    DNS_ERROR_INVALID_NAME(ERROR_INVALID_NAME.value),
    DNS_ERROR_INVALID_DATA(ERROR_INVALID_DATA.value),
    ...
    WSABASEERR(10000),
    WSAEINTR(WSABASEERR.value + 4),
    WSAEBADF(WSABASEERR.value + 9),
    WSAEACCES(WSABASEERR.value + 13),
    WSAEFAULT(WSABASEERR.value + 14),
    WSAEINVAL(WSABASEERR.value + 22),
    WSAEMFILE(WSABASEERR.value + 24),
    WSAEWOULDBLOCK(WSABASEERR.value + 35),
    WSAEINPROGRESS(WSABASEERR.value + 36),
    WSAEALREADY(WSABASEERR.value + 37),
    WSAENOTSOCK(WSABASEERR.value + 38),
    WSAEDESTADDRREQ(WSABASEERR.value + 39),
    WSAEMSGSIZE(WSABASEERR.value + 40),
    WSAEPROTOTYPE(WSABASEERR.value + 41),
    WSAENOPROTOOPT(WSABASEERR.value + 42),
    WSAEPROTONOSUPPORT(WSABASEERR.value + 43),
    WSAESOCKTNOSUPPORT(WSABASEERR.value + 44),
    WSAEOPNOTSUPP(WSABASEERR.value + 45),
    WSAEPFNOSUPPORT(WSABASEERR.value + 46),
    WSAEAFNOSUPPORT(WSABASEERR.value + 47),
    WSAEADDRINUSE(WSABASEERR.value + 48),
    WSAEADDRNOTAVAIL(WSABASEERR.value + 49),
    WSAENETDOWN(WSABASEERR.value + 50),
    WSAENETUNREACH(WSABASEERR.value + 51),
    WSAENETRESET(WSABASEERR.value + 52),
    WSAECONNABORTED(WSABASEERR.value + 53),
    WSAECONNRESET(WSABASEERR.value + 54),
    WSAENOBUFS(WSABASEERR.value + 55),
    WSAEISCONN(WSABASEERR.value + 56),
    WSAENOTCONN(WSABASEERR.value + 57),
    WSAESHUTDOWN(WSABASEERR.value + 58),
    WSAETOOMANYREFS(WSABASEERR.value + 59),
    WSAETIMEDOUT(WSABASEERR.value + 60),
    WSAECONNREFUSED(WSABASEERR.value + 61),
    WSAELOOP(WSABASEERR.value + 62),
    WSAENAMETOOLONG(WSABASEERR.value + 63),
    WSAEHOSTDOWN(WSABASEERR.value + 64),
    WSAEHOSTUNREACH(WSABASEERR.value + 65),
    WSAENOTEMPTY(WSABASEERR.value + 66),
    WSAEPROCLIM(WSABASEERR.value + 67),
    WSAEUSERS(WSABASEERR.value + 68),
    WSAEDQUOT(WSABASEERR.value + 69),
    WSAESTALE(WSABASEERR.value + 70),
    WSAEREMOTE(WSABASEERR.value + 71),
    WSASYSNOTREADY(WSABASEERR.value + 91),
    WSAVERNOTSUPPORTED(WSABASEERR.value + 92),
    WSANOTINITIALISED(WSABASEERR.value + 93),
    WSAEDISCON(WSABASEERR.value + 101),
    WSAENOMORE(WSABASEERR.value + 102),
    WSAECANCELLED(WSABASEERR.value + 103),
    WSAEINVALIDPROCTABLE(WSABASEERR.value + 104),
    WSAEINVALIDPROVIDER(WSABASEERR.value + 105),
    WSAEPROVIDERFAILEDINIT(WSABASEERR.value + 106),
    WSASYSCALLFAILURE(WSABASEERR.value + 107),
    WSASERVICE_NOT_FOUND(WSABASEERR.value + 108),
    WSATYPE_NOT_FOUND(WSABASEERR.value + 109),
    WSA_E_NO_MORE(WSABASEERR.value + 110),
    WSA_E_CANCELLED(WSABASEERR.value + 111),
    WSAEREFUSED(WSABASEERR.value + 112),
    WSAHOST_NOT_FOUND(WSABASEERR.value + 1001),
    WSATRY_AGAIN(WSABASEERR.value + 1002),
    WSANO_RECOVERY(WSABASEERR.value + 1003),
    WSANO_DATA(WSABASEERR.value + 1004),
    WSA_QOS_RECEIVERS(WSABASEERR.value + 1005),
    WSA_QOS_SENDERS(WSABASEERR.value + 1006),
    WSA_QOS_NO_SENDERS(WSABASEERR.value + 1007),
    WSA_QOS_NO_RECEIVERS(WSABASEERR.value + 1008),
    WSA_QOS_REQUEST_CONFIRMED(WSABASEERR.value + 1009),
    WSA_QOS_ADMISSION_FAILURE(WSABASEERR.value + 1010),
    WSA_QOS_POLICY_FAILURE(WSABASEERR.value + 1011),
    WSA_QOS_BAD_STYLE(WSABASEERR.value + 1012),
    WSA_QOS_BAD_OBJECT(WSABASEERR.value + 1013),
    WSA_QOS_TRAFFIC_CTRL_ERROR(WSABASEERR.value + 1014),
    WSA_QOS_GENERIC_ERROR(WSABASEERR.value + 1015),
    WSA_QOS_ESERVICETYPE(WSABASEERR.value + 1016),
    WSA_QOS_EFLOWSPEC(WSABASEERR.value + 1017),
    WSA_QOS_EPROVSPECBUF(WSABASEERR.value + 1018),
    WSA_QOS_EFILTERSTYLE(WSABASEERR.value + 1019),
    WSA_QOS_EFILTERTYPE(WSABASEERR.value + 1020),
    WSA_QOS_EFILTERCOUNT(WSABASEERR.value + 1021),
    WSA_QOS_EOBJLENGTH(WSABASEERR.value + 1022),
    WSA_QOS_EFLOWCOUNT(WSABASEERR.value + 1023),
    WSA_QOS_EUNKNOWNPSOBJ(WSABASEERR.value + 1024),
    WSA_QOS_EUNKOWNPSOBJ(WSA_QOS_EUNKNOWNPSOBJ.value),
    WSA_QOS_EPOLICYOBJ(WSABASEERR.value + 1025),
    WSA_QOS_EFLOWDESC(WSABASEERR.value + 1026),
    WSA_QOS_EPSFLOWSPEC(WSABASEERR.value + 1027),
    WSA_QOS_EPSFILTERSPEC(WSABASEERR.value + 1028),
    WSA_QOS_ESDMODEOBJ(WSABASEERR.value + 1029),
    WSA_QOS_ESHAPERATEOBJ(WSABASEERR.value + 1030),
    WSA_QOS_RESERVED_PETYPE(WSABASEERR.value + 1031),
